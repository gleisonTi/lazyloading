...
import { ReferenciaVariacao } from './referencia-variacao.model';
...
export class ReferenciaVariacaoService extends BaseRecursoService<ReferenciaVariacao> {

  public state: State
  httpClient: any;
  constructor(protected injector: Injector) {
    super(`${INCCA_WEB_URL}/basico/ReferenciaVariacoes`, `${INCCA_WEB_URL}/basico/ReferenciaVariacao`,
      injector,
      ReferenciaVariacao.fromJson);
  }
  ...
  public save(data: ReferenciaVariacao, isNew?: boolean) {
    if (isNew) {
